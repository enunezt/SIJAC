...
/**
 * The primary key class for the dignatarios database table.
 * 
 */
@Embeddable
public class DignatarioPK implements Serializable {
	...
	public DignatarioPK(Integer idJunta,Long idPersona,java.util.Date fecInicio,java.util.Date fecFin) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof DignatarioPK)) {
			return false;
		}
		DignatarioPK castOther = (DignatarioPK)other;
		return 
